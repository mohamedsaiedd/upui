...
@Component({
  tag: 'primary-no-border-btn',
  styleUrl: 'primary-no-border-btn.css',
  shadow: true,
})
export class PrimaryNoBorderBtn {
  @Prop() text: string;
  ...
  render() {
    return (
      <Host>
        <button class={'upui-btn upui-primary-no-border-btn ' + (this.btndisabled ? 'upui-primary-no-border-btn-disabled' : '')}>
