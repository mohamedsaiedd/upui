...
@Component({
  tag: 'secondary-no-border-btn',
  styleUrl: 'secondary-no-border-btn.css',
  shadow: true,
})
export class SecondaryNoBorderBtn {
  @Prop() text: string;
  ...
  render() {
    return (
      <Host>
        <button class={'upui-btn upui-secondary-no-border-btn ' + (this.btndisabled ? 'upui-secondary-no-border-btn-disabled' : '')}>
